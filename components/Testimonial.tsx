...
const testimonialData = [
  {
    ...
    message: 'Lorem ipsum dolor sit amet consectetur adipisicing elit Ad, dolorem!',
    name: 'Luiza Tavares',
  },
  {
...
const Testimonial = () => {
  return (
    <section className="py-12 xl:py-28" id="avaliações">
      <div className="container mx-auto">
        <motion.h2
          ...
          className="h2 text-center">Avaliações</motion.h2>
        <motion.div
