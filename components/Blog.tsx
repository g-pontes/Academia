...
const blogData = [
  {
    ...
    date: '10 de Março, 2014',
    title: 'Mantenha uma estrutura perfeita após o treino',
    href: '',
  },
  {
    ...
    <section className="bg-primary-300 text-white py-24" id="blog">
      <div className="container mx-auto">
        ...
        >
          ...
          >
            ...
            <SwiperNavButtons
              ...
              sm:max-w-[620px] md:max-w-[960px] xl:max-w-[1320px] mx-auto 
              z-50 flex justify-between gap-1'
              btnStyles='bg-accent text-while w-[36px] h-[36px] flex justify-center 
              items-center hover:bg-accent transition-all duration-300 rounded-full'
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.2 }}
        >
          <CustomButton containerStyles='block w-[196px] h-[62px] mx-auto' text='Veja Mais!' />
        </motion.div>
      </div>
    </section>
  )
